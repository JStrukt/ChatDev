...
from camel.typing import PhaseType
...
class RolePlaying:
    ...
    def __init__(
        ...
        user_role_type: RoleType | None = None,
        assistant_role_type: RoleType | None = None,
        ...
        sys_msg_meta_dicts = [
            dict(chatdev_prompt=chatdev_prompt_template, task=task_prompt),
        ] * 2
