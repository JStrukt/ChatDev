...
from chatdev.chat_env import ChatEnvConfig
...
please rewrite it into a detailed, comprehensive and extremely insightful prompt is perfectly suited to inform a large language model with the context and requirements of the software.
Help break the problem and requirements down into a detail-oriented, insightful and structured format and smaller sub-tasks.
